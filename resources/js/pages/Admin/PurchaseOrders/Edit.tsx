    ...
    const initialItems: PurchaseOrderItem[] =
        purchaseOrder.items.length > 0
            ? purchaseOrder.items.map((item) => ({
                  ...
                  conversion_qty: String(item.conversion_qty),
    ...
    const submit = (event: React.FormEvent) => {
        ...
        put(`/admin/purchase-orders/${purchaseOrder.id}`, {
            onError: (validationErrors) => {
                console.log(
                    'Purchase Order update validation errors:',
                    validationErrors,
                );
            },
        });
                    ...
                    <div className="rounded-xl border bg-card p-6">
                        <div className="mb-4 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Update the products and quantities being
                                    ordered.
                                </p>
                            </div>
                                        ...
                                        <tr key={item.id ?? `new-${index}`}>
                                            <td className="px-3 py-3">
                                                <select
                                                    ...
                                                    className="w-full min-w-60 rounded-md border bg-background px-3 py-2 text-sm"
                                                >
                                                    <option value="">
                                                        Select variant
                                                    </option>
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) =>
                                                        updateItem(
                                                            index,
                                                            'tax_type',
                                                            e.target.value as PurchaseOrderItem['tax_type'],
                                                        )
                                                    }
