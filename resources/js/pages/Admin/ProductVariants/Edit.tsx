...
export default function Edit({
    ...
    const existingPrice = productVariant.prices?.[0];
    const existingInventory = productVariant.inventories?.[0];
    ...
    const { data, setData, put, processing, errors } =
        useForm<ProductVariantForm>({
            ...
            tax_type: productVariant.tax_type,

            base_uom_id: String(productVariant.base_uom_id),

            selling_uom_id: String(productVariant.selling_uom_id),
            selling_qty: productVariant.selling_qty,

            purchasing_uom_id: String(productVariant.purchasing_uom_id),
            purchasing_qty: productVariant.purchasing_qty,

            price_list_id: existingPrice
                ? String(existingPrice.price_list_id)
                : '',
            price: existingPrice?.price ?? '',

            warehouse_id: existingInventory
                ? String(existingInventory.warehouse_id)
                : '',
            quantity_on_hand:
                existingInventory?.quantity_on_hand ?? '0',
            reorder_level:
                existingInventory?.reorder_level ?? '0',

            remarks: productVariant.remarks ?? '',
    ...
    const submit: FormEventHandler = (event) => {
        ...
        put(`/admin/product-variants/${productVariant.id}`);
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Update the variant, pricing, and inventory
                        information.
                    </p>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="rounded-lg border p-4">
                            ...
                            <p className="mb-4 text-sm text-muted-foreground">
                                Update the price assigned to this variant.
                            </p>
                        ...
                        <div className="rounded-lg border p-4">
                            ...
                            <p className="mb-4 text-sm text-muted-foreground">
                                Update the warehouse stock information.
                            </p>
